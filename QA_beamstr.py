...
def get_arguments():
    ...
    parser.add_argument('inputfile', type=str, help='Raw-data-file to QA.')
    parser.add_argument('--outputdir',  '-o', type=str, default='./plots/QA_beamstr', help='Output directory.')
    parser.add_argument('--corry',  '-e', type=str, default='/Users/yoonha/ITS3/corryvreckan/bin/corry', help='corry executable.')
...
if __name__=="__main__":
    ...
    if not args.plotting:
        ...
        root_file_name =    run_corry(run = run, stage = "analyse",     detectors_file = aligned_conf, output_dir=args.outputdir)
