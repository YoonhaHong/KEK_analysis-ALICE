...
coordinates = "cartesian"
orientation = 0deg,0deg,0deg # MOSS connected to J2/J3 when bottom is tested -> carrier 
                             # 180deg rotated around z in hardware compared to top MOSS 
                             # not the case for babyMOSS
orientation_mode = xyz
role = "auxiliary"
roi = [[100,0],[100,200],[320,200],[320,0]] # ROI to exclude glue holes
...
orientation_mode = xyz
role = "auxiliary"
roi = [[100,0],[100,200],[320,200],[320,0]]  # ROI to exclude PCB
